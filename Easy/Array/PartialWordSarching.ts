...
// the method returns an array containing a single string: "Empty" (or Nothing in Haskell, or "None" 
// in Python and C)

// Examples
// If the string to search for is "me", and the array to search is ["home", "milk", "Mercury", "fish"], the method should return ["home", "Mercury"].

export function wordSearch(query, seq){
    const res = seq.filter(elem => elem.toLowerCase().includes(query.toLowerCase()))
