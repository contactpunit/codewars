...
// Lyrics
const song = `99 bottles of beer on the wall, 99 bottles of beer.
...
export function sing() {
    ...
    for (let i = 99; i > 0; i--) {
        ...
        if (i === 1) lyrics.push(`Take one down and pass it around,no more bottles of beer on the wall.`)
        else if (i === 2) lyrics.push(`Take one down and pass it around, ${i - 1} bottle of beer on the wall.`)
        else lyrics.push(`Take one down and pass it around, ${i - 1} bottles of beer on the wall.`)
    }
